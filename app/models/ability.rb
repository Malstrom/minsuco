class Ability
  ...
  def initialize(user)
    ...
    # alias_action :publish, :publish_check, :to => :publish
    #
    # can :manage, :all
    # #user
    ...
    # can :publish, Race, owner:user
    # can :update, Race, owner:user
    #
    # #attendee
    # can :read, Attendee, user:user
    # can :create, Attendee, user:user
    # can :update, Attendee do
    #   attendee.user == user and
    #   attendee.race.owner == user
    # end
    #
    # #friends
    # can :manage, :friends, user:user
    #
    # #events
