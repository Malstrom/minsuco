...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { category: @race.category, category: @race.category, commission: @race.commission, compensation_start_amount: @race.compensation_start_amount, max_attendees: @race.max_attendees, name: @race.name, owner: @race.owner, pieces_amount: @race.pieces_amount, race_value: @race.race_value, recipients: @race.recipients } }
    end
